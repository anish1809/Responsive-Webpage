...
app.controller('messageController', function($scope,$http,$location,$routeParams) {
	var id = $routeParams.id;
	if(id==1)
		{
		$scope.message="Question Added Successfully";
		$scope.link="facultyhome";
		}
		else if(id==2)
			{
			$scope.message="Course Added Successfully";
			$scope.link="adminHome";
			}
		else if(id==3)
		{
		...
		{
		$scope.message="Department Added Successfully";
		$scope.link="adminHome";
		}
...
app.controller('MainCtrl', ['$scope', '$rootScope', 'localStorageService', 'sharedOrders', function($scope, $rootScope, localStorageService, sharedOrders) {
